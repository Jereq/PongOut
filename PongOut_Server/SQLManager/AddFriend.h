// AddFriend.h : Declaration of the CAddFriend

#pragma once

// code generated on den 9 oktober 2013, 10:34

class CAddFriendAccessor
{
public:
...
// store the password in some other form or use a different user authentication.
	...
	DEFINE_COMMAND_EX(CAddFriendAccessor, L"{ ? = CALL dbo.AddFriend(?,?) }")


	BEGIN_PARAM_MAP(CAddFriendAccessor)
...
class CAddFriend : public CCommand<CAccessor<CAddFriendAccessor>, CNoRowset >
{
public:
	HRESULT OpenAll()
	{
