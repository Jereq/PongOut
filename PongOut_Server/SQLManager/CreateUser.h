// CreateUser.h : Declaration of the CCreateUser

#pragma once

// code generated on den 8 oktober 2013, 13:56

class CCreateUserAccessor
{
public:
	...
	LONG m_RETURN_VALUE;
	TCHAR m_userName[8000];
	TCHAR m_userPassword[8000];
...
// store the password in some other form or use a different user authentication.
	...
	DEFINE_COMMAND_EX(CCreateUserAccessor, L"{ ? = CALL dbo.CreateUser(?,?) }")


	BEGIN_PARAM_MAP(CCreateUserAccessor)
...
class CCreateUser : public CCommand<CAccessor<CCreateUserAccessor>, CNoRowset >
{
public:
	HRESULT OpenAll()
	{
